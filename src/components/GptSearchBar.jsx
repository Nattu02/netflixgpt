    ...
    return (
        <div>
            <button
                ...
                className="absolute top-5 right-5 font-bold text-black bg-white py-1 px-3 rounded-md border-2 border-white z-20 cursor-pointer"
            >
                X
            </button>
            ...
            <div className="w-1/2 bg-black mx-auto rounded-md">
                ...
                >
                    <input
                        ...
                        className="col-span-3 p-3 my-2 ml-3 border-2 border-black rounded-md bg-white"
                    ></input>
                    <button
                        className="col-span-1 bg-red-600 p-2 m-2 rounded-md font-bold text-xl text-white cursor-pointer"
